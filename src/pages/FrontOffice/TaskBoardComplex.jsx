...
const TaskBoard = () => {
  ...
  const TaskCardDisplay = ({ task, isDragging = false }) => (
    <Card
      size="small"
      ...
      {!tasksLoading && (
        ...
        >
                ...
                >
                  ...
                  <div
                    ...
                    onDrop={(e) => {
                      ...
                      if (taskId) {
                        const currentTask = Object.values(tasksByStatus).flat().find(task => task.id === taskId);
                        if (currentTask && currentTask.status !== column.id) {
                          updateTaskStatus({
                            variables: {
                              id: taskId,
                              status: column.id,
                              notes: `Status changed from ${currentTask.status} to ${column.id}`
                            }
                          });
                        }
                      }
          ...
          <DragOverlay>
            {activeId ? (
              <TaskCardDisplay 
                task={Object.values(tasksByStatus).flat().find(task => task.id === activeId)} 
                isDragging={true}
              />
            ) : null}
          </DragOverlay>
