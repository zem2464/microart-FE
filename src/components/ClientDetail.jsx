...
import { Card, Row, Col, Tag, Typography, Space, Button, Spin, Tabs, Table, DatePicker, Statistic } from 'antd';
          ...
          <Card>
            {ledgerRangeLoading ? (
              ...
              (() => {
                ...
                const opening = Number(range?.openingBalance ?? client.openingBalance ?? 0);
