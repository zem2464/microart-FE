...
const TasksTable = ({
  ...
  const handleAssignQtyConfirm = useCallback(async () => {
    ...
    try {
      ...
      const usersToAdd = assignQtySelectedUserIds.filter((id) => !currentUserIds.includes(id));
      const usersToRemove = currentAssignments.filter((a) => !assignQtySelectedUserIds.includes(a.userId));
      const usersToUpdate = assignQtySelectedUserIds.filter((id) => currentUserIds.includes(id));
      ...
      for (const userId of usersToUpdate) {
        const assignment = currentAssignments.find((a) => a.userId === userId);
