    ...
    try {
      ...
      if (leaveType === 'SHORT') {
        ...
        if (durationType === 'HALF_DAY') {
          // Normalize value in case user previously picked a range
          const dateValue = Array.isArray(values.dateRange)
            ? values.dateRange[0]
            : values.dateRange;
          ...
          hours = 0.5; // Represent half-day as four working hours
        } else {
